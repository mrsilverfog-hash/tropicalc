...
public final class ShowdownIdMapper {
    ...
    static {
        ...
        TALENTS.put("rockypayload", "Porte-Roche");
        ...
        TALENTS.put("raindish", "Cuvette");
        TALENTS.put("overcoat", "Envelocape");
        TALENTS.put("sandveil", "Voile Sable");
        TALENTS.put("poisonheal", "Soin Poison");
        ...
        TALENTS.put("icescales", "Écailles Glacées");
        TALENTS.put("fluffy", "Boule de Poils");
        TALENTS.put("furcoat", "Toison Épaisse");
        TALENTS.put("dryskin", "Peau Sèche");
        ...
        OBJETS.put("safetygoggles", "Lunettes Filtre");
