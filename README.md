...
- Déduit progressivement le set le plus probable de l'adversaire (objet, talent, nature, répartition des EV) à partir des dégâts observés au fil du combat.

## Build

Ce projet compile entièrement via GitHub Actions (onglet **Actions** → artefact `tropicalc-build`). Aucune compilation locale n'est nécessaire.
